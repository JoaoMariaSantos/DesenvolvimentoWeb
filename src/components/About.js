                ...
                <div className="about__all-text">
                    <div className="about__maintext__container">
                        <p className="about__text text--paragraph">Grä was created in 2022 by <span className='ines text--green'>Inês</span>,
                            ...
                            We are three Design and Multimedia students from the University of Coimbra with professional experience and currently in our master's degree.
                        </p>
                        <br />
                        <br />
                        <br />
                        <p className="about__text text--paragraph">
                            We are three Design and Multimedia students from the University of Coimbra with professional experience and currently in our master's degree.
                        </p>
                        <br />
                        <br />
